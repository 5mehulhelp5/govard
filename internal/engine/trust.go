...
func exportRootCA() (rootCAExport, error) {
	...
	if err := os.MkdirAll(sslDir, bootstrap.DefaultDirPerm); err != nil {
	...
	if err := os.Chmod(tempCertPath, bootstrap.DefaultFilePerm); err != nil {
...
func ensureNSSDatabase(path string) error {
	...
	if err := os.MkdirAll(path, bootstrap.SecretDirPerm); err != nil {
