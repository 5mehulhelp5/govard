...
- **Apache Configuration:** Added shared Apache handling for legacy `index.php/` path patterns, including explicit `PATH_INFO` support so Magento 1 environments can use "pretty" URLs without dropping route segments.
